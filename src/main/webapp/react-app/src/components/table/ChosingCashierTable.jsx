...
export default function ChoosingCashierTable({tableRows, handleCreateCheck}) {
    ...
    const isSelected = (row) => selected.findIndex((item) => row.id === item.id) !== -1;
        ...
        <Box sx={{width: '100%'}}>
            ...
            <div className="flex justify-between items-center mt-3">
                <button
                    ...
                    onClick={() => handleCreateCheck(selected)}
                >
                   Get an information
                </button>
            </div>
