...
public class GetChecksSumByEmployeePerPeriod implements Command {

    private final CheckService checkService;

    public GetChecksSumByEmployeePerPeriod(CheckService checkService) {
    ...
    public String execute(HttpServletRequest request) throws IOException {
        ...
        double sum = checkService.getChecksSumByEmployeeIdPerPeriod(hashMap.get("id_employee"),
