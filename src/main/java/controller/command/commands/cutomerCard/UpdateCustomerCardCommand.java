...
public class UpdateCustomerCardCommand implements Command {

    private final CustomerService customerService;

    public UpdateCustomerCardCommand(CustomerService customerService) {
    ...
    public String execute(HttpServletRequest request) throws IOException {
        ...
        customerService.update(customerCard);
